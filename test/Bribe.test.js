...
describe('Bribe', function() {
  ...
  let gaugeControllerAddress, gaugeAddress, rewardtokenAddress, claimAddress;
  ...
  switch (project) {
    ...
    default:
      ...
      gaugeAddress = '0xB518f5e3242393d4eC792BD3f44946A3b98d0E48'; // MIM
      rewardtokenAddress = '0xD533a949740bb3306d119CC777fa900bA034cd52'; //CRV
      claimAddress = '0xF5bF3B7B7D03EfD34BA1E1BcF1694080975d8A1c';
      break;
  }
  before(async function() {
    Bribe = await ethers.getContractFactory('Bribe');
    bribe = await Bribe.deploy(gaugeControllerAddress, fee);
  ...
  describe('Claim reward', async function(){
    it('Should claim reward', async function(){
      ...
      let claimReward = await bribe.claimable(claimAddress, gaugeAddress, rewardtokenAddress);
